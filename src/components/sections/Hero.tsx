...
const Hero = () => {
  ...
  return <section id="hero" className="relative h-screen flex items-center pt-20 overflow-hidden" style={{
    ...
    backgroundPosition: 'center'
      ...
      <div ref={heroRef} className="section-container relative z-10 flex flex-col items-center justify-center text-center">
        <h1 className="text-5xl md:text-7xl font-display font-bold mb-6 aos" data-aos="fade-down" data-aos-delay="200">
          Priyanka Paul
        </h1>
        
        <div className="h-0.5 w-16 bg-primary my-6 aos" data-aos="zoom-in" data-aos-delay="400"></div>
        
        <h2 className="text-xl md:text-2xl leading-relaxed max-w-3xl font-medium text-gray-700 mb-8 aos" data-aos="fade-up" data-aos-delay="600">
        ...
        <div className="flex flex-col sm:flex-row gap-4 aos" data-aos="fade-up" data-aos-delay="800">
          <button onClick={scrollToAbout} className="px-8 py-4 rounded-md bg-primary text-white font-medium tracking-wide shadow-sm hover:bg-primary/90 hover:shadow-md transition-all duration-300 transform hover:-translate-y-1">
            Discover My Research
          </button>
          
          <a href="#publications" className="px-8 py-4 rounded-md bg-white text-primary border border-primary font-medium tracking-wide shadow-sm hover:bg-primary/5 hover:shadow-md transition-all duration-300 transform hover:-translate-y-1">
            View Publications
          </a>
        </div>
        
        <div ref={statsRef} className="mt-12 pt-8 border-t border-gray-200/50 flex flex-row justify-center w-full max-w-2xl aos" data-aos="fade-up" data-aos-delay="1000">
      ...
      {/* Scroll indicator */}
      <div ref={scrollIndicatorRef} className="absolute bottom-10 left-1/2 transform -translate-x-1/2 aos" data-aos="fade-up" data-aos-delay="1400">
