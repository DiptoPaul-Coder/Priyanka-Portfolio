  ...
  return <section id="hero" className="relative h-screen flex items-center pt-20 overflow-hidden" style={{
    ...
    backgroundPosition: 'center'
      ...
      <div ref={heroRef} className="section-container relative z-10 flex flex-col items-center justify-center text-center">
        <h1 className="text-5xl md:text-7xl font-display font-bold mb-6 opacity-0 animate-fade-in" style={{
        animationDelay: '200ms'
      }}>
          Priyanka Paul
        </h1>
        
        <div className="h-0.5 w-16 bg-primary my-6 opacity-0 animate-fade-in" style={{
        animationDelay: '400ms'
      }}></div>
        
        <h2 className="text-xl md:text-2xl leading-relaxed max-w-3xl font-medium text-gray-700 mb-8 opacity-0 animate-fade-in" style={{
      ...
      {/* Scroll indicator */}
      <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 opacity-0 animate-fade-in" style={{
      animationDelay: '1000ms'
    }}>
