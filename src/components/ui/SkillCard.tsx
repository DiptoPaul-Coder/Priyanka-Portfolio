...
const SkillCard = ({ title, skills, icon, delay }: SkillCardProps) => {
  return (
    <div 
      className="skill-card p-6 bg-white rounded-lg shadow-sm border border-gray-100 transition-all duration-300 hover:shadow-md hover:-translate-y-1 opacity-0 animate-fade-in"
